...
trait InputAttrs[N, DomElement <: DomNode, DomNode] { this: AttrBuilder[N, DomElement, DomNode] =>
  ...
  /**
    ...
    * MDN
    */
  lazy val action: InputAttr[String] = attr("action")
  ...
  /**
    ...
    * MDN
    */
  lazy val autoComplete: InputAttr[String] = attr("autocomplete")
  ...
  /**
    ...
    * MDN
    */
  lazy val autoFocus: InputAttr[Boolean] = attr("autofocus")
  ...
  /**
    ...
    * MDN
    */
  lazy val checked: InputAttr[Boolean] = attr("checked")

  /**
    * The `enctype` attribute provides the encoding type of the form when it is
    * submitted (for forms with a method of "POST").
    */
  lazy val encType: InputAttr[String] = attr("enctype")

  /**
    * The form attribute specifies one or more forms an `<input>` element belongs to.
    */
  lazy val formAttr: InputAttr[String] = attr("form") // TODO: Conflicts with "form" element
  ...
  /**
    ...
    * submit or image.
    */
  lazy val formAction: InputAttr[String] = attr("formaction")
  ...
  /**
    ...
    */
  lazy val formEncType: InputAttr[String] = attr("formenctype")
  ...
  /**
    ...
    * or "image".
    */
  lazy val formMethod: InputAttr[String] = attr("formmethod")
  ...
  /**
    ...
    */
  lazy val max: InputAttr[String] = attr("max")

  /**
    * The min attribute specifies the minimum value for an <input> element of type
    * number, range, date, datetime, datetime-local, month, time, or week.
    */
  lazy val min: InputAttr[String] = attr("min")
  ...
  /**
    ...
    * option.
    */
  lazy val multiple: InputAttr[Boolean] = attr("multiple")
  ...
  /**
    ...
    */
  lazy val maxLength: InputAttr[Int] = attr("maxlength")
  ...
  /**
    ...
    * MDN
    */
  lazy val method: InputAttr[String] = attr("method")
  ...
  /**
    ...
    * MDN
    */
  lazy val name: InputAttr[String] = attr("name")
  ...
  /**
    ...
    */
  lazy val pattern: InputAttr[String] = attr("pattern")
  ...
  /**
    ...
    * MDN
    */
  lazy val placeholder: InputAttr[String] = attr("placeholder")
  ...
  /**
    ...
    * MDN
    */
  lazy val readOnly: InputAttr[Boolean] = attr("readonly")
  ...
  /**
    ...
    * MDN
    */
  lazy val required: InputAttr[Boolean] = attr("required")
  ...
  /**
    ...
    * MDN
    */
  lazy val size: InputAttr[Int] = attr("size")
  ...
  /**
    ...
    */
  lazy val step: InputAttr[String] = attr("step")
  ...
  /**
    ...
    */
  lazy val target: InputAttr[String] = attr("target")
  ...
  /**
    ...
    * MDN
    */
  lazy val `type`: InputAttr[String] = attr("type")

  /**
    * Shorthand for the `type` attribute
    */
  lazy val tpe: InputAttr[String] = `type`

  /**
    * Shorthand for the `type` attribute
    */
  lazy val typ: InputAttr[String] = `type`
  ...
  /**
    ...
    * MDN
    */
  lazy val value: InputAttr[String] = attr("value")

  /**
    * The `width` attribute specifies the width of an `input` element of
    * `type` "image".
    */
  lazy val widthAttr: InputAttr[Int] = attr("width") // TODO: Conflicts with "width" in Styles
}
