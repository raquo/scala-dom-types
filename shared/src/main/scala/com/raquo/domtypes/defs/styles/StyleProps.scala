...
object StyleProps {
  ...
  val defs: List[StylePropDef] = List(
    ...
    StylePropDef(
      ...
      valueType = "String",
      valueTraits = List("Normal"),
      implName = "normalStyle",
      commentLines = List(
    ...
    StylePropDef(
      ...
      domName = "line-height",
      valueType = "String",
      valueTraits = List("Length", "Normal"),
