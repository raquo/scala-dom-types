...
import com.raquo.domtypes.old.defs.styles.keywords
import com.raquo.domtypes.old.defs.styles.units.{CalcUnits, LengthUnits, TimeUnits, UrlUnits}
...
trait StylePropBuilder[Prop[_], Setter[_], DerivedProp[_], LengthNum] {
  ...
  type LengthStyle = Prop[String] with LengthUnits[DerivedProp, LengthNum] with StyleStringValueBuilder[Setter[String]]
  ...
  type TimeStyle = Prop[String] with TimeUnits[DerivedProp] with StyleStringValueBuilder[Setter[String]]

  type UrlStyle = Prop[String] with UrlUnits[DerivedProp] with StyleStringValueBuilder[Setter[String]]
  ...
  protected def intStyle(key: String): Prop[Int] with CalcUnits[DerivedProp] with StyleStringValueBuilder[Setter[Int]]

  protected def doubleStyle(key: String): Prop[Double] with CalcUnits[DerivedProp] with StyleStringValueBuilder[Setter[Double]]
