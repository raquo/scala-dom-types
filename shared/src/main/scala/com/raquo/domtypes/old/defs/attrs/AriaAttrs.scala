package com.raquo.domtypes.old.defs.attrs
...
trait AriaAttrs[A[_]] { this: HtmlAttrBuilder[A] =>
  ...
  /**
    ...
    */
  lazy val atomic: A[Boolean] = boolTrueFalseHtmlAttr("aria-atomic")
  ...
  /**
    ...
    */
  lazy val busy: A[Boolean] = boolTrueFalseHtmlAttr("aria-busy")
  ...
  /**
    ...
    */
  lazy val disabled: A[Boolean] = boolTrueFalseHtmlAttr("aria-disabled")
  ...
  /**
    ...
    */
  lazy val expanded: A[Boolean] = boolTrueFalseHtmlAttr("aria-expanded")
  ...
  /**
    ...
    */
  lazy val grabbed: A[Boolean] = boolTrueFalseHtmlAttr("aria-grabbed")
  ...
  /**
    ...
    */
  lazy val hasPopup: A[Boolean] = boolTrueFalseHtmlAttr("aria-haspopup")
  ...
  /**
    ...
    */
  lazy val hidden: A[Boolean] = boolTrueFalseHtmlAttr("aria-hidden")
  ...
  /**
    ...
    */
  lazy val multiLine: A[Boolean] = boolTrueFalseHtmlAttr("aria-multiline")
  ...
  /**
    ...
    */
  lazy val multiSelectable: A[Boolean] = boolTrueFalseHtmlAttr("aria-multiselectable")
  ...
  /**
    ...
    */
  lazy val readOnly: A[Boolean] = boolTrueFalseHtmlAttr("aria-readonly")
  ...
  /**
    ...
    */
  lazy val required: A[Boolean] = boolTrueFalseHtmlAttr("aria-required")
  ...
  /**
    ...
    */
  lazy val selected: A[Boolean] = boolTrueFalseHtmlAttr("aria-selected")
