...
trait DocumentTags[T[_ <: DomHtmlElement], DomHtmlElement, Html <: DomHtmlElement, HtmlHead <: DomHtmlElement, HtmlBase <: DomHtmlElement, HtmlLink <: DomHtmlElement, HtmlMeta <: DomHtmlElement, HtmlScript <: DomHtmlElement, HtmlElement <: DomHtmlElement] {
  ...
  /**
    ...
    *  MDN
    */
  @inline def html: T[Html] = htmlTag("html")
  ...
  /**
    ...
    *  MDN
    */
  @inline def head: T[HtmlHead] = htmlTag("head")
  ...
  /**
    ...
    *  MDN
    */
  @inline def base: T[HtmlBase] = htmlTag("base", void = true)
  ...
  /**
    ...
    *  MDN
    */
  @inline def link: T[HtmlLink] = htmlTag("link", void = true)
  ...
  /**
    ...
    *  MDN
    */
  @inline def meta: T[HtmlMeta] = htmlTag("meta", void = true)
  ...
  /**
    ...
    *  MDN
    */
  @inline def script: T[HtmlScript] = htmlTag("script")
  ...
  /**
    ...
    *  MDN
    */
  @inline def noScript: T[HtmlElement] = htmlTag("noscript")
}
