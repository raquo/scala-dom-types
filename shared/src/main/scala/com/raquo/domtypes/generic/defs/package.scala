...
package object defs {
  ...
  object sameRefTags {
    ...
    type GroupingTags[T[_ <: N], N] = generic.defs.tags.GroupingTags[T, N, N, N, N, N, N, N, N, N, N, N, N, N]
    ...
    type TableTags[T[_ <: N], N] = generic.defs.tags.TableTags[T, N, N, N, N, N, N, N, N]
