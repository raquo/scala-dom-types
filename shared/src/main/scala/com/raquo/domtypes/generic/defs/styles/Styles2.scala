...
trait Styles2[StyleSetter] extends StylesMisc[StyleSetter] { this: StyleBuilders[StyleSetter] =>
  ...
  /**
    ...
    * MDN
    */
  @inline def animationDirection: Style[String] = style("animationDirection", "animation-direction")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationDuration: Style[String] = style("animationDuration", "animation-duration")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationName: Style[String] = style("animationName", "animation-name")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationFillMode: Style[String] = style("animationFillMode", "animation-fill-mode")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationIterationCount: Style[Int] = style("animationIterationCount", "animation-iteration-count")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationDelay = new MultiTimeStyle("animationDelay", "animation-delay")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationTimingFunction: Style[String] = style("animationTimingFunction", "animation-timing-function")
  ...
  /**
    ...
    * MDN
    */
  @inline def animationPlayState: Style[String] = style("animationPlayState", "animation-play-state")
  /**
    ...
    * MDN
    */
  @inline def animation: Style[String] = style("animation", "animation")
  ...
  /**
    ...
    * MDN
    */
  @inline def columnCount: AutoStyle[Int] = new AutoStyle("columnCount", "column-count")
  ...
  object columnFill extends Style[String]("columnFill", "column-fill") {
    ...
    /**
      ...
      * MDN
      */
    @inline def balance: StyleSetter = buildStringStyleSetter(this, "balance")
  }
  ...
  /**
    ...
    * MDN
    */
  @inline def columnGap = new NormalOpenStyle[String]("columnGap", "column-gap")
  ...
  /**
    ...
    * MDN
    */
  @inline def columnRule: Style[String] = style("columnRule", "column-rule")
  ...
  /**
    ...
    * MDN
    */
  @inline def columnWidth = new AutoStyle[Int]("columnWidth", "column-width")
  ...
  /**
    ...
    * MDN
    */
  @inline def columnRuleColor: Style[String] = style("columnRuleColor", "column-rule-color")
  ...
  /**
    ...
    * MDN
    */
  @inline def content: Style[String] = style("content", "content")
  ...
  /**
    ...
    * MDN
    */
  @inline def counterIncrement: Style[String] = style("counterIncrement", "counter-increment")
  ...
  /**
    ...
    * MDN
    */
  @inline def counterReset: Style[String] = style("counterReset", "counter-reset")
  ...
  /**
    ...
    * MDN
    */
  @inline def orphans: Style[Int] = style("orphans", "orphans")
  ...
  /**
    ...
    * MDN
    */
  @inline def widows: Style[Int] = style("widows", "widows")
  ...
  /**
    ...
    * MDN
    */
  @inline def pageBreakAfter = new PageBreak("pageBreakAfter", "page-break-after")
  ...
  /**
    ...
    * MDN
    */
  @inline def pageBreakInside = new PageBreak("pageBreakInside", "page-break-inside")
  ...
  /**
    ...
    * MDN
    */
  @inline def pageBreakBefore = new PageBreak("pageBreakBefore", "page-break-before")
  ...
  /**
    ...
    * MDN
    */
  @inline def perspective = new NoneOpenStyle[String]("perspective", "perspective")
  ...
  /**
    ...
    * MDN
    */
  @inline def perspectiveOrigin: Style[String] = style("perspectiveOrigin", "perspective-origin")
  ...
  /**
    ...
    * MDN
    */
  @inline def transform: Style[String] = style("transform", "transform")
  ...
  /**
    ...
    * MDN
    */
  @inline def transformOrigin: Style[String] = style("transformOrigin", "transform-origin")
  ...
  object transformStyle extends Style[String]("transformStyle", "transform-style") {
    /**
      ...
      * MDN
      */
    @inline def `preserve-3d`: StyleSetter = buildStringStyleSetter(this, "preserve-3d")
    /**
      ...
      * MDN
      */
    @inline def flat: StyleSetter = buildStringStyleSetter(this, "flat")
  }
  ...
  object unicodeBidi extends Style[String]("unicodeBidi", "unicode-bidi") {
    ...
    /**
      ...
      * MDN
      */
    @inline def embed: StyleSetter = buildStringStyleSetter(this, "embed")
    /**
      ...
      * MDN
      */
    @inline def `bidi-override`: StyleSetter = buildStringStyleSetter(this, "bidi-override")
  }
  ...
  object wordBreak extends Style[String]("wordBreak", "word-break") {
    ...
    /**
      ...
      * MDN
      */
    @inline def breakAll: StyleSetter = buildStringStyleSetter(this, "break-all")
    ...
    /**
      ...
      * MDN
      */
    @inline def keepAll: StyleSetter = buildStringStyleSetter(this, "keep-all")
