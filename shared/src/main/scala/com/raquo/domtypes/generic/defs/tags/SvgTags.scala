...
trait SvgTags[T[_ <: SvgElement], SvgElement,
  ...
  /**
    ...
    * MDN
    */
  @inline def altGlyph: T[SvgElement] = svgTag("altGlyph")
  ...
  /**
    ...
    * MDN
    */
  @inline def altGlyphDef: T[SvgElement] = svgTag("altGlyphDef")
  ...
  /**
    ...
    * MDN
    */
  @inline def altGlyphItem: T[SvgElement] = svgTag("altGlyphItem")
  ...
  /**
    ...
    * MDN
    */
  @inline def animate: T[SvgElement] = svgTag("animate")
  ...
  /**
    ...
    * MDN
    */
  @inline def animateMotion: T[SvgElement] = svgTag("animateMotion")
  ...
  /**
    ...
    * MDN
    */
  @inline def animateTransform: T[SvgElement] = svgTag("animateTransform")
  ...
  /**
    ...
    * MDN
    */
  @inline def circle: T[SvgCircle] = svgTag("circle")
  ...
  /**
    ...
    * MDN
    */
  @inline def clipPathTag: T[SvgClipPath] = svgTag("clipPath")
  ...
  /**
    ...
    * MDN
    */
  @inline def colorProfileTag: T[SvgElement] = svgTag("color-profile")
  ...
  /**
    ...
    * MDN
    */
  @inline def cursor: T[SvgElement] = svgTag("cursor")
  ...
  /**
    ...
    * MDN
    */
  @inline def defs: T[SvgDefs] = svgTag("defs")
  ...
  /**
    ...
    * MDN
    */
  @inline def desc: T[SvgDesc] = svgTag("desc")
  ...
  /**
    ...
    * MDN
    */
  @inline def ellipse: T[SvgEllipse] = svgTag("ellipse")
  ...
  /**
    ...
    * MDN
    */
  @inline def feBlend: T[SvgFEBlend] = svgTag("feBlend")
  ...
  /**
    ...
    * MDN
    */
  @inline def feColorMatrix: T[SvgFEColorMatrix] = svgTag("feColorMatrix")
  ...
  /**
    ...
    * MDN
    */
  @inline def feComponentTransfer: T[SvgComponentTransferFunction] = svgTag("feComponentTransfer")
  ...
  /**
    ...
    * MDN
    */
  @inline def feComposite: T[SvgFEComposite] = svgTag("feComposite")
  ...
  /**
    ...
    * MDN
    */
  @inline def feConvolveMatrix: T[SvgFEConvolveMatrix] = svgTag("feConvolveMatrix")
  ...
  /**
    ...
    * MDN
    */
  @inline def feDiffuseLighting: T[SvgFEDiffuseLighting] = svgTag("feDiffuseLighting")
  ...
  /**
    ...
    * MDN
    */
  @inline def feDisplacementMap: T[SvgFEDisplacementMap] = svgTag("feDisplacementMap")
  ...
  /**
    ...
    * MDN
    */
  @inline def feDistantLighting: T[SvgFEDistantLight] = svgTag("feDistantLighting")
  ...
  /**
    ...
    * MDN
    */
  @inline def feFlood: T[SvgFEFlood] = svgTag("feFlood")
  ...
  /**
    ...
    * MDN
    */
  @inline def feFuncA: T[SvgFEFuncA] = svgTag("feFuncA")
  ...
  /**
    ...
    * MDN
    */
  @inline def feFuncB: T[SvgFEFuncB] = svgTag("feFuncB")
  ...
  /**
    ...
    * MDN
    */
  @inline def feFuncG: T[SvgFEFuncG] = svgTag("feFuncG")
  ...
  /**
    ...
    * MDN
    */
  @inline def feFuncR: T[SvgFEFuncR] = svgTag("feFuncR")
  ...
  /**
    ...
    * MDN
    */
  @inline def feGaussianBlur: T[SvgFEGaussianBlur] = svgTag("feGaussianBlur")
  ...
  /**
    ...
    * MDN
    */
  @inline def feImage: T[SvgFEImage] = svgTag("feImage")
  ...
  /**
    ...
    * MDN
    */
  @inline def feMerge: T[SvgFEMerge] = svgTag("feMerge")
  ...
  /**
    ...
    * MDN
    */
  @inline def feMergeNode: T[SvgFEMergeNode] = svgTag("feMergeNode")
  ...
  /**
    ...
    * MDN
    */
  @inline def feMorphology: T[SvgFEMorphology] = svgTag("feMorphology")
  ...
  /**
    ...
    * MDN
    */
  @inline def feOffset: T[SvgFEOffset] = svgTag("feOffset")

  /**
    *
    */
  @inline def fePointLight: T[SvgFEPointLight] = svgTag("fePointLight")
  ...
  /**
    ...
    * MDN
    */
  @inline def feSpecularLighting: T[SvgFESpecularLighting] = svgTag("feSpecularLighting")

  /**
    *
    */
  @inline def feSpotlight: T[SvgFESpotLight] = svgTag("feSpotlight")
  ...
  /**
    ...
    * MDN
    */
  @inline def feTile: T[SvgFETile] = svgTag("feTile")
  ...
  /**
    ...
    * MDN
    */
  @inline def feTurbulance: T[SvgFETurbulence] = svgTag("feTurbulance")
  ...
  /**
    ...
    * MDN
    */
  @inline def filter: T[SvgFilter] = svgTag("filter")
  ...
  /**
    ...
    * MDN
    */
  @inline def font: T[SvgElement] = svgTag("font")
  ...
  /**
    ...
    * MDN
    */
  @inline def fontFace: T[SvgElement] = svgTag("font-face")
  ...
  /**
    ...
    * MDN
    */
  @inline def fontFaceFormat: T[SvgElement] = svgTag("font-face-format")
  ...
  /**
    ...
    * MDN
    */
  @inline def fontFaceName: T[SvgElement] = svgTag("font-face-name")
  ...
  /**
    ...
    * MDN
    */
  @inline def fontFaceSrc: T[SvgElement] = svgTag("font-face-src")
  ...
  /**
    ...
    * MDN
    */
  @inline def fontFaceUri: T[SvgElement] = svgTag("font-face-uri")
  ...
  /**
    ...
    * MDN
    */
  @inline def foreignObject: T[SvgElement] = svgTag("foreignObject")
  ...
  /**
    ...
    * MDN
    */
  @inline def glyph: T[SvgElement] = svgTag("glyph")
  ...
  /**
    ...
    * MDN
    */
  @inline def glyphRef: T[SvgElement] = svgTag("glyphRef")
  ...
  /**
    ...
    * MDN
    */
  @inline def hkern: T[SvgElement] = svgTag("hkern")
  ...
  /**
    ...
    * MDN
    */
  @inline def image: T[SvgImage] = svgTag("image")
  ...
  /**
    ...
    * MDN
    */
  @inline def line: T[SvgLine] = svgTag("line")
  ...
  /**
    ...
    * MDN
    */
  @inline def linearGradient: T[SvgLinearGradient] = svgTag("linearGradient")
  ...
  /**
    ...
    * MDN
    */
  @inline def marker: T[SvgMarker] = svgTag("marker")
  ...
  /**
    ...
    * MDN
    */
  @inline def mask: T[SvgMask] = svgTag("mask")
  ...
  /**
    ...
    * MDN
    */
  @inline def metadata: T[SvgMetadata] = svgTag("metadata")
  ...
  /**
    ...
    * MDN
    */
  @inline def missingGlyph: T[SvgElement] = svgTag("missing-glyph")
  ...
  /**
    ...
    * MDN
    */
  @inline def pattern: T[SvgPattern] = svgTag("pattern")
  ...
  /**
    ...
    * MDN
    */
  @inline def polygon: T[SvgPolygon] = svgTag("polygon")
  ...
  /**
    ...
    * MDN
    */
  @inline def polyline: T[SvgPolyline] = svgTag("polyline")
  ...
  /**
    ...
    * MDN
    */
  @inline def radialGradient: T[SvgRadialGradient] = svgTag("radialGradient")
  ...
  /**
    ...
    * MDN
    */
  @inline def rect: T[SvgRectElement] = svgTag("rect")
  ...
  /**
    ...
    * MDN
    */
  @inline def set: T[SvgElement] = svgTag("set")
  ...
  /**
    ...
    * MDN
    */
  @inline def stop: T[SvgStop] = svgTag("stop")
  ...
  /**
    ...
    * MDN
    */
  @inline def svg: T[Svg] = svgTag("svg")
  ...
  /**
    ...
    * MDN
    */
  @inline def switch: T[SvgSwitch] = svgTag("switch")
  ...
  /**
    ...
    * MDN
    */
  @inline def symbol: T[SvgSymbol] = svgTag("symbol")
  ...
  /**
    ...
    * MDN
    */
  @inline def text: T[SvgText] = svgTag("text")
  ...
  /**
    ...
    * MDN
    */
  @inline def textPath: T[SvgTextPath] = svgTag("textPath")
  ...
  /**
    ...
    * MDN
    */
  @inline def tref: T[SvgElement] = svgTag("tref")
  ...
  /**
    ...
    * MDN
    */
  @inline def tspan: T[SvgTSpan] = svgTag("tspan")
  ...
  /**
    ...
    * MDN
    */
  @inline def use: T[SvgUse] = svgTag("use")
  ...
  /**
    ...
    * MDN
    */
  @inline def view: T[SvgView] = svgTag("view")
  ...
  /**
    ...
    * MDN
    */
  @inline def vkern: T[SvgElement] = svgTag("vkern")
}
