...
trait LengthUnits[T[_]] extends CalcUnits[T] {
  ...
  /** Pixels */
  lazy val px: T[Double] = derivedStyle(n => s"${n}px")

  /** 1 pt is 4/3 of a pixel. */
  lazy val pt: T[Double] = derivedStyle(n => s"${n}pt")

  lazy val percent: T[Double] = derivedStyle(n => s"${n}%")
  ...
  /**
    ...
    * element.  --MDN
    */
  lazy val em: T[Double] = derivedStyle(n => s"${n}em")
  ...
  /**
    ...
    * may modify this).  --MDN
    */
  lazy val rem: T[Double] = derivedStyle(n => s"${n}rem")
  ...
  /**
    ...
    */
  lazy val ch: T[Double] = derivedStyle(n => s"${n}ch")
