...
trait ReflectedHtmlAttrs[RA[_, _]] { this: ReflectedHtmlAttrBuilder[RA] =>
  ...
  /**
    ...
    * MDN
    */
  @inline def accept: RA[String, String] = stringReflectedAttr("accept")
  ...
  /**
    ...
    */
  @inline def action: RA[String, String] = stringReflectedAttr("action")

  /**
    * Specifies a shortcut key to activate/focus an element
    */
  @inline def accessKey: RA[String, String] = stringReflectedAttr(attrKey = "accesskey", propKey = "accessKey")
  ...
  /**
    ...
    * MDN
    */
  @inline def alt: RA[String, String] = stringReflectedAttr("alt")
  ...
  /**
    ...
    */
  @inline def autoCapitalize: RA[String, String] = stringReflectedAttr("autocapitalize")
  ...
  /**
    ...
    * MDN
    */
  @inline def autoComplete: RA[String, String] = stringReflectedAttr("autocomplete")
  ...
  /**
    ...
    * MDN
    */
  @inline def autoFocus: RA[Boolean, Boolean] = booleanReflectedAttr("autofocus", attrCodec = BooleanAsAttrPresenceCodec)
  ...
  /**
    ...
    * MDN
    */
  @inline def cols: RA[Int, Int] = intReflectedAttr("cols")
  ...
  /**
    ...
    * MDN
    */
  @inline def colSpan: RA[Int, Int] = intReflectedAttr(attrKey = "colspan", propKey = "colSpan")
  ...
  /**
    ...
    * MDN
    */
  @inline def contentAttr: RA[String, String] = stringReflectedAttr("content")
  ...
  /**
    ...
    * MDN
    */
  @inline def defaultChecked: RA[Boolean, Boolean] = booleanReflectedAttr(
    attrKey = "checked",
  ...
  /**
    ...
    */
  @inline def defaultSelected: RA[Boolean, Boolean] = booleanReflectedAttr(
    attrKey = "selected",
  ...
  /**
    ...
    * MDN
    */
  @inline def defaultValue: RA[String, String] = stringReflectedAttr(attrKey = "value", propKey = "defaultValue")
  ...
  /**
    ...
    */
  @inline def dir: RA[String, String] = stringReflectedAttr("dir")
  ...
  /**
    ...
    * MDN
    */
  @inline def disabled: RA[Boolean, Boolean] = booleanReflectedAttr("disabled", attrCodec = BooleanAsAttrPresenceCodec)

  /**
    * Specifies whether an element is draggable or not
    */
  @inline def draggable: RA[Boolean, Boolean] = booleanReflectedAttr("draggable", attrCodec = BooleanAsTrueFalseStringCodec)
  ...
  /**
    ...
    * Only applies to [[com.raquo.domtypes.generic.defs.tags.FormTags.form]]
    */
  @inline def encType: RA[String, String] = stringReflectedAttr("enctype")
  ...
  /**
    ...
    * MDN
    */
  @inline def forId: RA[String, String] = stringReflectedAttr(attrKey = "for", propKey = "htmlFor")
  ...
  /**
    ...
    * submit or image.
    */
  @inline def formAction: RA[String, String] = stringReflectedAttr(attrKey = "formaction", propKey = "formAction")
  ...
  /**
    ...
    */
  @inline def formEncType: RA[String, String] = stringReflectedAttr(attrKey = "formenctype", propKey = "formEnctype")
  ...
  /**
    ...
    * Enumerated: "post" | "get"
    */
  @inline def formMethod: RA[String, String] = stringReflectedAttr(attrKey = "formmethod", propKey = "formMethod")
  ...
  /**
    ...
    * of `type` "submit".
    */
  @inline def formNoValidate: RA[Boolean, Boolean] = booleanReflectedAttr(
  ...
  /**
    ...
    */
  @inline def formTarget: RA[String, String] = stringReflectedAttr(attrKey = "formtarget", propKey = "formTarget")
  ...
  /**
    ...
    */
  @inline def hidden: RA[Boolean, Boolean] = booleanReflectedAttr("hidden", attrCodec = BooleanAsAttrPresenceCodec)
  ...
  /**
    ...
    */
  @inline def high: RA[Double, Double] = doubleReflectedAttr("high")
  ...
  /**
    ...
    * MDN
    */
  @inline def href: RA[String, String] = stringReflectedAttr("href")
  ...
  /**
    ...
    * MDN
    */
  @inline def httpEquiv: RA[String, String] = stringReflectedAttr(attrKey = "http-equiv", propKey = "httpEquiv")
  ...
  /**
    ...
    * MDN
    */
  @inline def id: RA[String, String] = stringReflectedAttr("id")
  ...
  /**
    ...
    * MDN
    */
  @inline def lang: RA[String, String] = stringReflectedAttr("lang")
  ...
  /**
    ...
    * @see https://css-tricks.com/html5-meter-element/
    */
  @inline def low: RA[Double, Double] = doubleReflectedAttr("low")
  ...
  /**
    ...
    * MDN
    */
  @inline def minLength: RA[Int, Int] = intReflectedAttr(attrKey = "minlength", propKey = "minLength")
  ...
  /**
    ...
    */
  @inline def maxLength: RA[Int, Int] = intReflectedAttr(attrKey = "maxlength", propKey = "maxLength")
  ...
  /**
    ...
    */
  @inline def media: RA[String, String] = stringReflectedAttr("media")
  ...
  /**
    ...
    * MDN
    */
  @inline def method: RA[String, String] = stringReflectedAttr("method")
  ...
  /**
    ...
    * option.
    */
  @inline def multiple: RA[Boolean, Boolean] = booleanReflectedAttr("multiple", attrCodec = BooleanAsAttrPresenceCodec)
  ...
  /**
    ...
    * MDN
    */
  @inline def name: RA[String, String] = stringReflectedAttr("name")
  ...
  /**
    ...
    */
  @inline def noValidate: RA[Boolean, Boolean] = booleanReflectedAttr(
    attrKey = "novalidate",
    propKey = "noValidate",
    attrCodec = BooleanAsAttrPresenceCodec
  )
  ...
  /**
    ...
    * @see https://css-tricks.com/html5-meter-element/
    */
  @inline def optimum: RA[Double, Double] = doubleReflectedAttr("optimum")
  ...
  /**
    ...
    */
  @inline def pattern: RA[String, String] = stringReflectedAttr("pattern")
  ...
  /**
    ...
    * MDN
    */
  @inline def placeholder: RA[String, String] = stringReflectedAttr("placeholder")
  ...
  /**
    ...
    * MDN
    */
  @inline def readOnly: RA[Boolean, Boolean] = booleanReflectedAttr(
    attrKey = "readonly",
    propKey = "readOnly",
    attrCodec = BooleanAsAttrPresenceCodec
  )
  ...
  /**
    ...
    * MDN
    */
  @inline def required: RA[Boolean, Boolean] = booleanReflectedAttr("required", attrCodec = BooleanAsAttrPresenceCodec)
  ...
  /**
    ...
    * MDN
    */
  @inline def rows: RA[Int, Int] = intReflectedAttr("rows")
  ...
  /**
    ...
    * MDN
    */
  @inline def rowSpan: RA[Int, Int] = intReflectedAttr(attrKey = "rowspan", propKey = "rowSpan")
  ...
  /**
    ...
    */
  @inline def scoped: RA[Boolean, Boolean] = booleanReflectedAttr("scoped", attrCodec = BooleanAsAttrPresenceCodec)
  ...
  /**
    ...
    * MDN
    */
  @inline def size: RA[Int, Int] = intReflectedAttr("size")
  ...
  /**
    ...
    */
  @inline def spellCheck: RA[Boolean, Boolean] = booleanReflectedAttr("spellcheck", attrCodec = BooleanAsTrueFalseStringCodec)
  ...
  /**
    ...
    * MDN
    */
  @inline def src: RA[String, String] = stringReflectedAttr("src")
  ...
  /**
    ...
    */
  @inline def tabIndex: RA[Int, Int] = intReflectedAttr(attrKey = "tabindex", propKey = "tabIndex")
  ...
  /**
    ...
    */
  @inline def target: RA[String, String] = stringReflectedAttr("target")
  ...
  /**
    ...
    * MDN
    */
  @inline def title: RA[String, String] = stringReflectedAttr("title")

  /**
    * Specifies whether the content of an element should be translated or not
    */
  @inline def translate: RA[Boolean, Boolean] = booleanReflectedAttr("translate", attrCodec = BooleanAsYesNoStringCodec)

  /**
    * Specifies XML namespace for the document
    */
  @inline def xmlns: RA[String, String] = stringReflectedAttr("xmlns")
}
