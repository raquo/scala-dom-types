...
trait ComplexHtmlKeys[ClassNameRA, RelRA, RoleRA, DataA, StyleA, TextContentP] {
  ...
  // @TODO[Performance] Wouldn't `@inline def` be better for aliasing in Scala.js? className will be overriden with a @inline def anyway.
  @inline def cls: ClassNameRA = className
