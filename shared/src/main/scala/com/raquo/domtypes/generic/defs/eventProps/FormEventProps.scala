...
trait FormEventProps[
  ...
  /**
    ...
    * MDN
    */
  @inline final def onChange: EP[DomHtmlElementTargetEvent] = eventProp("change")
  ...
  /**
    ...
    * MDN
    */
  @inline final def onSelect: EP[DomHtmlElementTargetEvent] = eventProp("select")

  /**
    * The input event is fired for input, select, textarea, and
    * contentEditable elements when it gets user input.
    */
  @inline final def onInput: EP[DomHtmlElementTargetEvent] = eventProp("input")
  ...
  /**
    ...
    * MDN
    */
  @inline final def onBlur: EP[DomElementFocusEvent] = eventProp("blur")
  ...
  /**
    ...
    * MDN
    */
  @inline final def onFocus: EP[DomElementFocusEvent] = eventProp("focus")
  ...
  /**
    ...
    * MDN
    */
  @inline final def onSubmit: EP[DomFormElementTargetEvent] = eventProp("submit")
  ...
  /**
    ...
    * MDN
    */
  @inline final def onReset: EP[DomFormElementTargetEvent] = eventProp("reset")

  /**
    * Script to be run when an element is invalid
    */
  @inline final def onInvalid: EP[DomElementTargetEvent] = eventProp("invalid")

  /**
    * Fires when the user writes something in a search field (for <input="search">)
    */
  @inline final def onSearch: EP[DomInputElementTargetEvent] = eventProp("search")
}
