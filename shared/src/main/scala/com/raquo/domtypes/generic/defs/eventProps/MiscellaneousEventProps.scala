...
trait MiscellaneousEventProps[EP[_ <: DomEvent], DomEvent, DomUIEvent <: DomEvent] { this: EventPropBuilder[EP, DomEvent] =>
  ...
  /**
    ...
    */
  @inline def onLoad: EP[DomUIEvent] = eventProp("load")
  ...
  /**
    ...
    */
  @inline def onResize: EP[DomUIEvent] = eventProp("resize")
  ...
  /**
    ...
    */
  @inline def onScroll: EP[DomUIEvent] = eventProp("scroll")

  /**
    * Fires when a <menu> element is shown as a context menu
    */
  @inline def onShow: EP[DomEvent] = eventProp("show")

  /**
    * Fires when the user opens or closes the <details> element
    */
  @inline def onToggle: EP[DomEvent] = eventProp("toggle")
}
