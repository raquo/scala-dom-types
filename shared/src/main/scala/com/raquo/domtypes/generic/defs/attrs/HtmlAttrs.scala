...
trait HtmlAttrs[A[_]] { this: HtmlAttrBuilder[A] =>
  ...
  /**
    ...
    * MDN
    */
  @inline def charset: A[String] = stringHtmlAttr("charset")
  ...
  /**
    ...
    */
  @inline def contentEditable: A[Boolean] = htmlAttr("contenteditable", BooleanAsTrueFalseStringCodec)
  ...
  /**
    ...
    */
  @inline def contextMenuId: A[String] = stringHtmlAttr("contextmenu")

  /**
    * Specifies whether the dragged data is copied, moved, or linked, when dropped
    * Acceptable values: `copy` | `move` | `link`
    */
  @inline def dropZone: A[String] = stringHtmlAttr("dropzone")

  /**
    * The form attribute specifies an ID of the form an `<input>` element belongs to.
    */
  @inline def formId: A[String] = stringHtmlAttr("form")
  ...
  /**
    ...
    */
  @inline def heightAttr: A[Int] = intHtmlAttr("height")
  ...
  /**
    ...
    */
  @inline def listId: A[String] = stringHtmlAttr("list")
  ...
  /**
    ...
    */
  @inline def max: A[String] = stringHtmlAttr("max")

  /**
    * The min attribute specifies the minimum value for an <input> element of type
    * number, range, date, datetime, datetime-local, month, time, or week.
    */
  @inline def min: A[String] = stringHtmlAttr("min")
  ...
  /**
    ...
    */
  @inline def step: A[String] = stringHtmlAttr("step")
  ...
  /**
    ...
    * MDN
    */
  @inline def `type`: A[String] = stringHtmlAttr("type")
  ...
  @inline def unselectable: A[Boolean] = htmlAttr("unselectable", BooleanAsOnOffStringCodec)

  /**
    * The `width` attribute specifies the pixel width of the following elements:
    * `<canvas>, <embed>, <iframe>, <img>, <input type="image">, <object>, <video>`
    */
  @inline def widthAttr: A[Int] = intHtmlAttr("width")
}
