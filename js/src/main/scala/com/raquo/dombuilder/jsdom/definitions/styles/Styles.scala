...
/**
  ...
  */
trait Styles extends StyleMisc { this: StyleBuilder =>
  ...
  /**
    ...
    * MDN
    */
  lazy val background = build[String]("background", "background")
  ...
  /**
    ...
    * MDN
    */
  lazy val backgroundRepeat = build[String]("backgroundRepeat", "background-repeat")
  ...
  /**
    ...
    * MDN
    */
  lazy val backgroundPosition = build[String]("backgroundPosition", "background-position")
  ...
  /**
    ...
    * MDN
    */
  lazy val backgroundColor = build[String]("backgroundColor", "background-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderTopColor = build[String]("borderTopColor", "border-top-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderStyle = build[String]("borderStyle", "border-style")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderRightColor = build[String]("borderRightColor", "border-right-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderBottom = build[String]("borderBottom", "border-bottom")
  ...
  /**
    ...
    * MDN
    */
  lazy val border = build[String]("border", "border")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderLeftColor = build[String]("borderLeftColor", "border-left-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderBottomColor = build[String]("borderBottomColor", "border-bottom-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderLeft = build[String]("borderLeft", "border-left")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderRight = build[String]("borderRight", "border-right")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderTop = build[String]("borderTop", "border-top")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderRadius = build[String]("borderRadius", "border-radius")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderWidth = build[String]("borderWidth", "border-width")
  ...
  /**
    ...
    * MDN
    */
  lazy val borderColor = build[String]("borderColor", "border-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val opacity = build[Double]("opacity", "opacity")
  ...
  /**
    ...
    * MDN
    */
  lazy val paddingRight = build[String]("paddingRight", "padding-right")
  ...
  /**
    ...
    * MDN
    */
  lazy val paddingTop = build[String]("paddingTop", "padding-top")
  ...
  /**
    ...
    * MDN
    */
  lazy val paddingLeft = build[String]("paddingLeft", "padding-left")
  ...
  /**
    ...
    * MDN
    */
  lazy val padding = build[String]("padding", "padding")
  ...
  /**
    ...
    * MDN
    */
  lazy val paddingBottom = build[String]("paddingBottom", "padding-bottom")
  ...
  /**
    ...
    * MDN
    */
  lazy val listStyle = build[String]("listStyle", "list-style")
  ...
  /**
    ...
    * MDN
    */
  lazy val boxShadow = build[String]("boxShadow", "box-shadow")
  ...
  /**
    ...
    * MDN
    */
  lazy val fontSizeAdjust = build[Double | String]("fontSizeAdjust", "font-size-adjust")
  ...
  /**
    ...
    * MDN
    */
  lazy val fontFamily = build[String]("fontFamily", "font-family")
  ...
  /**
    ...
    * MDN
    */
  lazy val font = build[String]("font", "font")
  ...
  /**
    ...
    * MDN
    */
  lazy val fontFeatureSettings = build[String]("fontFeatureSettings", "font-feature-settings")
  ...
  /**
    ...
    * MDN
    */
  lazy val outline = build[String]("outline", "outline")
  ...
  /**
    ...
    * MDN
    */
  lazy val textIndent = build[String]("textIndent", "text-indent")
  ...
  /**
    ...
    * MDN
    */
  lazy val transition = build[String]("transition", "transition")
  ...
  /**
    ...
    * MDN
    */
  lazy val transitionTimingFunction = build[String]("transitionTimingFunction", "transition-timing-function")
  ...
  /**
    ...
    * MDN
    */
  lazy val transitionProperty = build[String]("transitionProperty", "transition-property")
  ...
  /**
    ...
    * MDN
    */
  final lazy val flex = build[String]("flex", "flex")
  ...
  /**
    ...
    * MDN
    */
  final lazy val flexBasis = build[String]("flexBasis", "flex-basis")
