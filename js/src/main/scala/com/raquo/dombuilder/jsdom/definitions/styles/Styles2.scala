...
/**
  ...
  */
trait Styles2 extends StyleMisc { this: StyleBuilder =>
  ...
  /**
    ...
    * MDN
    */
  lazy val animationDirection = build[String]("animationDirection", "animation-direction")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationDuration = build[String]("animationDuration", "animation-duration")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationName = build[String]("animationName", "animation-name")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationFillMode = build[String]("animationFillMode", "animation-fill-mode")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationIterationCount = build[Int]("animationIterationCount", "animation-iteration-count")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationTimingFunction = build[String]("animationTimingFunction", "animation-timing-function")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationPlayState = build[String]("animationPlayState", "animation-play-state")
  /**
    ...
    * MDN
    */
  lazy val animation = build[String]("animation", "animation")
  ...
  /**
    ...
    * MDN
    */
  lazy val columnRule = build[String]("columnRule", "column-rule")
  ...
  /**
    ...
    * MDN
    */
  lazy val columnRuleColor = build[String]("columnRuleColor", "column-rule-color")
  ...
  /**
    ...
    * MDN
    */
  lazy val content = build[String]("content", "content")
  ...
  /**
    ...
    * MDN
    */
  lazy val counterIncrement = build[String]("counterIncrement", "counter-increment")
  ...
  /**
    ...
    * MDN
    */
  lazy val counterReset = build[String]("counterReset", "counter-reset")
  ...
  /**
    ...
    * MDN
    */
  lazy val orphans = build[Int | String]("orphans", "orphans")
  ...
  /**
    ...
    * MDN
    */
  lazy val widows = build[Int | String]("widows", "widows")
  ...
  /**
    ...
    * MDN
    */
  lazy val perspectiveOrigin = build[String]("perspectiveOrigin", "perspective-origin")
  ...
  /**
    ...
    * MDN
    */
  lazy val transform = build[String]("transform", "transform")
  ...
  /**
    ...
    * MDN
    */
  lazy val transformOrigin = build[String]("transformOrigin", "transform-origin")
