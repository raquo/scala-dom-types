...
trait Props {
  ...
  def prop[V, _DomV](name: String, reflectedAttrName: Option[String], codec: Codec[V, _DomV]): Prop[V] = Prop(name, reflectedAttrName, codec)


  @inline protected def boolProp(name: String, reflectedAttrName: String = null): Prop[Boolean] = prop(name, Option(reflectedAttrName), Codec.booleanAsIs)

  @inline protected def doubleProp(name: String, reflectedAttrName: String = null): Prop[Double] = prop(name, Option(reflectedAttrName), Codec.doubleAsIs)

  @inline protected def intProp(name: String, reflectedAttrName: String = null): Prop[Int] = prop(name, Option(reflectedAttrName), Codec.intAsIs)

  @inline protected def stringProp(name: String, reflectedAttrName: String = null): Prop[String] = prop(name, Option(reflectedAttrName), Codec.stringAsIs)
  ...
  /**
    ...
    */
  lazy val indeterminate: Prop[Boolean] = boolProp("indeterminate")
  ...
  /**
    ...
    */
  lazy val checked: Prop[Boolean] = boolProp("checked")
  ...
  /**
    ...
    */
  lazy val selected: Prop[Boolean] = boolProp("selected")
  ...
  /**
    ...
    */
  lazy val value: Prop[String] = stringProp("value")
  ...
  /**
    ...
    */
  lazy val accept: Prop[String] = stringProp("accept", reflectedAttrName = "accept")
  ...
  /**
    ...
    */
  lazy val action: Prop[String] = stringProp("action", reflectedAttrName = "action")
  ...
  /**
    ...
    */
  lazy val accessKey: Prop[String] = stringProp("accessKey", reflectedAttrName = "accesskey")
  ...
  /**
    ...
    */
  lazy val alt: Prop[String] = stringProp("alt", reflectedAttrName = "alt")
  ...
  /**
    ...
    */
  lazy val autoCapitalize: Prop[String] = stringProp("autocapitalize", reflectedAttrName = "autocapitalize")
  ...
  /**
    ...
    */
  lazy val autoComplete: Prop[String] = stringProp("autocomplete", reflectedAttrName = "autocomplete")
  ...
  /**
    ...
    */
  lazy val autoFocus: Prop[Boolean] = boolProp("autofocus", reflectedAttrName = "autofocus")
  ...
  /**
    ...
    */
  lazy val cols: Prop[Int] = intProp("cols", reflectedAttrName = "cols")
  ...
  /**
    ...
    */
  lazy val colSpan: Prop[Int] = intProp("colSpan", reflectedAttrName = "colspan")
  ...
  /**
    ...
    */
  lazy val contentAttr: Prop[String] = stringProp("content", reflectedAttrName = "content")
  ...
  /**
    ...
    */
  lazy val defaultChecked: Prop[Boolean] = boolProp("defaultChecked", reflectedAttrName = "checked")
  ...
  /**
    ...
    */
  lazy val defaultSelected: Prop[Boolean] = boolProp("defaultSelected", reflectedAttrName = "selected")
  ...
  /**
    ...
    */
  lazy val defaultValue: Prop[String] = stringProp("defaultValue", reflectedAttrName = "value")
  ...
  /**
    ...
    */
  lazy val dir: Prop[String] = stringProp("dir", reflectedAttrName = "dir")
  ...
  /**
    ...
    */
  lazy val disabled: Prop[Boolean] = boolProp("disabled", reflectedAttrName = "disabled")
  ...
  /**
    ...
    */
  lazy val download: Prop[String] = stringProp("download", reflectedAttrName = "download")
  ...
  /**
    ...
    */
  lazy val draggable: Prop[Boolean] = boolProp("draggable", reflectedAttrName = "draggable")
  ...
  /**
    ...
    */
  lazy val encType: Prop[String] = stringProp("enctype", reflectedAttrName = "enctype")
  ...
  /**
    ...
    */
  lazy val forId: Prop[String] = stringProp("htmlFor", reflectedAttrName = "for")
  ...
  /**
    ...
    */
  lazy val formEncType: Prop[String] = stringProp("formEnctype", reflectedAttrName = "formenctype")
  ...
  /**
    ...
    */
  lazy val formMethod: Prop[String] = stringProp("formMethod", reflectedAttrName = "formmethod")
  ...
  /**
    ...
    */
  lazy val formNoValidate: Prop[Boolean] = boolProp("formNoValidate", reflectedAttrName = "formnovalidate")
  ...
  /**
    ...
    */
  lazy val formTarget: Prop[String] = stringProp("formTarget", reflectedAttrName = "formtarget")
  ...
  /**
    ...
    */
  lazy val hidden: Prop[Boolean] = boolProp("hidden", reflectedAttrName = "hidden")
  ...
  /**
    ...
    */
  lazy val high: Prop[Double] = doubleProp("high", reflectedAttrName = "high")
  ...
  /**
    ...
    */
  lazy val httpEquiv: Prop[String] = stringProp("httpEquiv", reflectedAttrName = "http-equiv")
  ...
  /**
    ...
    */
  lazy val idAttr: Prop[String] = stringProp("id", reflectedAttrName = "id")
  ...
  /**
    ...
    */
  lazy val inputMode: Prop[String] = stringProp("inputMode", reflectedAttrName = "inputmode")
  ...
  /**
    ...
    */
  lazy val labelAttr: Prop[String] = stringProp("label", reflectedAttrName = "label")
  ...
  /**
    ...
    */
  lazy val lang: Prop[String] = stringProp("lang", reflectedAttrName = "lang")
  ...
  /**
    ...
    */
  lazy val loadingAttr: Prop[String] = stringProp("loading", reflectedAttrName = "loading")
  ...
  /**
    ...
    */
  lazy val low: Prop[Double] = doubleProp("low", reflectedAttrName = "low")
  ...
  /**
    ...
    */
  lazy val minLength: Prop[Int] = intProp("minLength", reflectedAttrName = "minlength")
  ...
  /**
    ...
    */
  lazy val maxLength: Prop[Int] = intProp("maxLength", reflectedAttrName = "maxlength")
  ...
  /**
    ...
    */
  lazy val media: Prop[String] = stringProp("media", reflectedAttrName = "media")
  ...
  /**
    ...
    */
  lazy val method: Prop[String] = stringProp("method", reflectedAttrName = "method")
  ...
  /**
    ...
    */
  lazy val multiple: Prop[Boolean] = boolProp("multiple", reflectedAttrName = "multiple")
  ...
  /**
    ...
    */
  lazy val nameAttr: Prop[String] = stringProp("name", reflectedAttrName = "name")
  ...
  /**
    ...
    */
  lazy val noValidate: Prop[Boolean] = boolProp("noValidate", reflectedAttrName = "novalidate")
  ...
  /**
    ...
    */
  lazy val optimum: Prop[Double] = doubleProp("optimum", reflectedAttrName = "optimum")
  ...
  /**
    ...
    */
  lazy val pattern: Prop[String] = stringProp("pattern", reflectedAttrName = "pattern")
  ...
  /**
    ...
    */
  lazy val placeholder: Prop[String] = stringProp("placeholder", reflectedAttrName = "placeholder")
  ...
  /**
    ...
    */
  lazy val readOnly: Prop[Boolean] = boolProp("readOnly", reflectedAttrName = "readonly")
  ...
  /**
    ...
    */
  lazy val required: Prop[Boolean] = boolProp("required", reflectedAttrName = "required")
  ...
  /**
    ...
    */
  lazy val rows: Prop[Int] = intProp("rows", reflectedAttrName = "rows")
  ...
  /**
    ...
    */
  lazy val rowSpan: Prop[Int] = intProp("rowSpan", reflectedAttrName = "rowspan")
  ...
  /**
    ...
    */
  lazy val scoped: Prop[Boolean] = boolProp("scoped", reflectedAttrName = "scoped")
  ...
  /**
    ...
    */
  lazy val size: Prop[Int] = intProp("size", reflectedAttrName = "size")
  ...
  /**
    ...
    */
  lazy val slot: Prop[String] = stringProp("slot", reflectedAttrName = "slot")
  ...
  /**
    ...
    */
  lazy val spellCheck: Prop[Boolean] = boolProp("spellcheck", reflectedAttrName = "spellcheck")
  ...
  /**
    ...
    */
  lazy val tabIndex: Prop[Int] = intProp("tabIndex", reflectedAttrName = "tabindex")
  ...
  /**
    ...
    */
  lazy val target: Prop[String] = stringProp("target", reflectedAttrName = "target")
  ...
  /**
    ...
    */
  lazy val title: Prop[String] = stringProp("title", reflectedAttrName = "title")
  ...
  /**
    ...
    */
  lazy val translate: Prop[Boolean] = boolProp("translate", reflectedAttrName = "translate")


  /** Specifies XML namespace for the document */
  lazy val xmlns: Prop[String] = stringProp("xmlns", reflectedAttrName = "xmlns")
  ...
  /**
    ...
    */
  lazy val crossOrigin: Prop[String] = stringProp("crossOrigin", reflectedAttrName = "crossorigin")
