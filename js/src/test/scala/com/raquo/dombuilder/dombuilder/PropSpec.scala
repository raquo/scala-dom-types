...
import com.raquo.dombuilder.dombuilder.jsdom.simple.tags.{div, input, span, td}
import com.raquo.dombuilder.dombuilder.jsdom.simple.props.{alt, colSpan, disabled, href, rel, rowSpan}
