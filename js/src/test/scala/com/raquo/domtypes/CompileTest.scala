...
import com.raquo.domtypes.jsdom.defs.eventProps.{ClipboardEventProps, ErrorEventProps, EventPropsInHTMLElement, FormEventProps, KeyboardEventProps, MediaEventProps, MiscellaneousEventProps, MouseEventProps, WindowEventProps}
...
class CompileTest {
  ...
  object SpecificEventProps
    extends EventPropsInHTMLElement[EventProp]
    with CanonicalEventPropBuilder[dom.Event]
}
